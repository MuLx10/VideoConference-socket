...
class videosocket:
    ...
    def vsend(self, framestring):
        ...
        while metasent < 8 :
            ...
            if sent == 0 :
                raise RuntimeError("Socket connection broken metasent")
            metasent += sent
        ...
        while totalsent < length :
            ...
            if sent == 0:
                raise RuntimeError("Socket connection broken tss")
            totalsent += sent
    ...
    def vreceive(self):
        ...
        while metarec < 8:
            ...
            if chunk == '' :
                raise RuntimeError("Socket connection broken metarec")
        ...
        while totrec<length :
            ...
            if chunk == '':
                raise RuntimeError("Socket connection broken ttr")
